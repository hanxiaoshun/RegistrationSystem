...
let byy03 = [
    ...
    '（3） 具有大专及以上本专业或相关专业毕业证书，并取得本职业或相关职业四级/ 中级工职业资格证书 （ 技能等级证书）后，累计从事本职业或相关职业工作２年（ 含） 以上。 ',
    '注：\n' +
    '1、包括婴幼儿发展引导员、幼儿教师、儿科医师、儿科护士、孤残儿童护理员、 母婴保健技术服务人员、保健护理师、健康管理师、育婴员、家政服务员等，下同。 \n' +
    '2、本专业：包括学前教育、早期教育，下同。 \n' +
    '3、中职相关专业包括护理、中医护理、家政服务与管理、营养与保健、助产' +
    '高 职高专相关专业包括：护理、预防医学、公共卫生管理、人口与家庭发展服务、临床医学、 中医学、食品营养与卫生、健康管理、医学营养、心理咨询、特殊教育、心理健康教育、幼 儿发展与健康管理' +
    '普通高校：相关专业包括护理学、基础医学、预防医学、中医学、妇幼保 健医学、教育学，下同 '];
...
// 20200408 修改如下：
// A.防腐蚀工、无机化学反应生产工、工业气体生产工、
// 压缩机操作工、尿素生产工、合成氨生产工、硝酸生产工、硫酸生产工，共8个工种：
let hg05 = [
    '（1）累计从事本职业或相关职业工作1年（含）以上。',
    '（2）本职业或相关职业学徒期满。'];
let hg04 = [
...
let hg03 = ['（1）取得本职业或相关职业四级/中级工职业资格证书（技能等级证书）后，累计从事本职业或相关职业工作5年（含）以上。',
    ...
    '注：' +
	'1防腐蚀工本职业包含但不限于下列工种：' +
	'耐蚀衬胶工、耐蚀喷涂工、耐蚀砖板衬里工、耐蚀塑料工、耐蚀纤维增强塑料工、耐蚀混凝土工。' +
	'2硫酸生产工本职业包含但不限于下列工种：' +
	'硫化物焙烧工、二氧化硫净化工、二氧化硫转化工、酸性气体干吸工、硫酸尾气处理工。' +
	'3硝酸生产工本职业包含但不限于下列工种：' +
	'氨氧化工  浓硝酸工' +
	'4合成氨生产工本职业包含但不限于下列工种：' +
	'合成氨煤气化工、合成氨转变工、合成氨净化工、合成氨气体压缩工、氨合成工、合成氨二氧化碳回收工、合成氨装置操作工。' +
	'5尿素生产工本职业包含但不限于下列工种：' +
	'尿素合成工、尿素加工工、尿素装置操作工。' +
	'6无机化学反应生产工本职业包含但不限于下列工种：' +
	'电化学反应工、窑炉反应工、黄磷生产工、电石生产工、钛白粉生产工、高频等离子工、二硫化碳生产工、炭黑生产工。' +
	'7工业气体生产工本职业包含但不限于下列工种：' +
	'制氢工、特种气体生产工、气体净化工溶解乙炔生产工、混合气生产工、气体充装工、气瓶检验工、医用供气工、工业供气工。'];
//===============================================
//化工增强,B 化学检验员， 从0408开始添加
let hxjyy05 = [
...
function get_worker_level_condition_selected(obj) {
    ...
    m.set('hg04', hg04);
    m.set('hg03', hg03);
	m.set('hxjyy05', hxjyy05);
	m.set('hxjyy04', hxjyy04);
	m.set('hxjyy03', hxjyy03);
    m.set('ffsg05', ffsg05);
    m.set('ffsg04', ffsg04);
    m.set('ffsg03', ffsg03);
