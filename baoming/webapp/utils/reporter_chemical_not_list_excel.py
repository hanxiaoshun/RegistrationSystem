...
def reporter_chemical_not_list():
    ...
    try:
        ...
        data = pd.read_excel(document_root + "/fujian04_excel.xlsx",
                             sheet_name='Sheet1')
        ...
        #                          sheet_name='Sheet1')
        # else:
        #     data = pd.read_excel("/opt/python3_space/lelingzdy/baoming/webapp/utils/fujian04_excel.xlsx",
        #                          sheet_name='Sheet1')
        ...
        if len(student_infos) > 0:
            ...
            for student in student_infos:
                ...
                data.loc[tmp_num + 4] = [tmp_num,
                                         ...
                                         student.user_info.middle_school,
...
def reporter_chemical_not_list_bak():
    """
    非化学类的
    :return:
    """
