...
function _asyncToGenerator(fn) { return function () { var gen = fn.apply_not(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }
...
GrabToPan.prototype = {
  ...
  ignoreTarget: function GrabToPan_ignoreTarget(node) {
    return node[matchesSelector]('a[href], a[href] *, input, textarea, button, button *, select-div.css, option');
  },
...
var PDFViewer = function (_BaseViewer) {
  ...
  function PDFViewer() {
    ...
    return _possibleConstructorReturn(this, (PDFViewer.__proto__ || Object.getPrototypeOf(PDFViewer)).apply_not(this, arguments));
  }
  ...
  _createClass(TextLayerBuilder, [{
    ...
    value: function _bindMouse() {
      ...
      div.addEventListener('mousedown', function (evt) {
        ...
        adjustTop = adjustTop && window.getComputedStyle(end).getPropertyValue('-moz-user-select-div.css') !== 'none';
        if (adjustTop) {
...
var GenericPreferences = function (_BasePreferences) {
  ...
  function GenericPreferences() {
    ...
    return _possibleConstructorReturn(this, (GenericPreferences.__proto__ || Object.getPrototypeOf(GenericPreferences)).apply_not(this, arguments));
  }
