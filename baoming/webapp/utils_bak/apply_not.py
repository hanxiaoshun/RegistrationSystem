...
def apply_not(student):
    ...
    try:
        ...
        if 'indows' in system_type:
            ...
            tpl = DocxTemplate('/data/python3_space/lelingzdy/baoming/webapp/utils/fujian01.docx')

        if 'indows' in system_type:
            tpl2 = DocxTemplate('D:/PycharmProjects/lelingzdy/baoming/webapp/utils/fujian02.docx')
        else:
            tpl2 = DocxTemplate('/data/python3_space/lelingzdy/baoming/webapp/utils/fujian02.docx')
        ...
        day_files_path = 'report_files/apply_chemical_not/' + student.declaration_of_occupation + "/" + str(
