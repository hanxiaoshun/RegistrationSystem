...
def reporter_chemical_list(student_infos=None):
    ...
    try:
        ...
        if 'indows' in system_type:
            ...
            data = pd.read_excel("/data/python3_space/lelingzdy/baoming/webapp/utils/huagonginfo.xlsx",
                                 sheet_name='Sheet1')
        ...
        if len(student_infos) > 0:
            ...
            for student in student_infos:
                ...
                if education_degree:
                    ...
                    education_name = ''
                tmp_num = tmp_num + 1
                data.loc[tmp_num + 1] = [tmp_num, identification_level, student.declaration_of_occupation,
                                         student.user_info.id_number,
                                         student.user_info.real_name, get_sex(student.user_info.sex),
                                         student.user_info.work_unit,
                                         student.user_info.birthday,
                                         student.user_info.start_working_date, 2,
                                         original_certificate_number,
            ...
            day_files_path = 'django/reporter_chemical_list' + "/files/" + day_string
